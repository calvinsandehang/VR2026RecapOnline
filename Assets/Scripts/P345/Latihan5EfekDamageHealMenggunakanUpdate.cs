...
public class Latihan5EfekDamageHealMenggunakanUpdate : MonoBehaviour
{
    ...
    [SerializeField] private float _lowHpPercentage = 0.25f;
    ...
    private void Awake()
    {
        ...
        currentEffectColor = _damageColor;
        currentAlpha = 0f;
        targetAlpha = 0f;
    }
    ...
    private void UpdateHpText()
    {
        ...
        if (currentHp <= _maxHp * _lowHpPercentage)
        {
            hpColor = "red";
        }
    ...
    {
        return currentHp <= _maxHp * _lowHpPercentage;
    }
